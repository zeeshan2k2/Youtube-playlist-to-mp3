...
def dowmp3():
    ...
    browser = webdriver.Chrome("/Users/zeeshanwaheed/Desktop/PycharmProjects1/Youtube playlist to mp3/chromedriver",
...
os.chdir("/Users/zeeshanwaheed/Downloads")  # copy your download folder path here
Path(file_name)
