...
Note: ideally this should work great if the videos on your playlist that are about 1 to 6 min long(it was initially made to convert songs), but if you want to convert longer videos(i.e podcasts etc) you'll have to increase and adjust time.sleep(n).                                                                                                                                                                                                             
